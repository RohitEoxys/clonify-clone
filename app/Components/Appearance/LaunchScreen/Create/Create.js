...
import SelectBgColor from "./SelectBackgroundColor/SelectBgColor";
  ...
  return (
    <div className="main">
      ...
      <div className="mt-[31px]">
        ...
        {/* left */}
        <div className="flex justify-between md:items-center gap-x-2 flex-col md:flex-row mt-5 ">
          <div>
            <h6 className="text-main text-[16px]">Select Background Image</h6>
            <div>
              <div className="mt-5 bg-[#eaebeb] items-center flex flex-col max-[1279px]:py-[96px] py-[70.5px] px-[50px] mb-5 md:mb-2">
                ...
                <div className="mt-[20px]  text-main font-normal text-center">
          ...
          <div className=" lg:self-start">
            <h6 className="text-main text-[16px]  mb-5">
              Select Background Color
            </h6>
            <SelectBgColor />
            <div className="flex justify-between mt-8 md:mt-[18px] gap-x-5 md:flex-col xl:flex-row ">
